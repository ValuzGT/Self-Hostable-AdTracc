...
class MinecraftCaptchaListener extends discord_akairo_1.Listener {
    constructor() {
        super('mc-capthca', {
            emitter: 'minecraft',
            event: 'messagestr',
    ...
    exec(msg) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (msg === "Use /recaptcha if the captcha is too hard to read.") {
                ...
                (_a = this.client.mcBot) === null || _a === void 0 ? void 0 : _a.end();
            }
        });
    }
}
exports.default = MinecraftCaptchaListener;
